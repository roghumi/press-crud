...
class QueryHasOneRelation implements IQueryRelation
{
    ...
    {
        return new QueryHasOneRelation($request, $name, $providerClass, ...$args);
    }
    ...
    {
        return function (HasOne $relation) use ($data) {
