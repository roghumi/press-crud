...
class QueryHasOneThroughRelation implements IQueryRelation
{
    ...
    {
        return new QueryHasOneThroughRelation($request, $name, $providerClass, ...$args);
    }
    ...
    {
        return function (HasOneThrough $relation) use ($data) {
