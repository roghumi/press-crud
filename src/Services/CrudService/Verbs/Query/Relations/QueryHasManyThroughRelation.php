...
class QueryHasManyThroughRelation implements IQueryRelation
{
    ...
    {
        return new QueryHasManyThroughRelation($request, $name, $providerClass, ...$args);
    }
    ...
    {
        return function (HasManyThrough $relation) use ($data) {
