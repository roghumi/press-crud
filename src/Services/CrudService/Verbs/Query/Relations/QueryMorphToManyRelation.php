...
class QueryMorphToManyRelation implements IQueryRelation
{
    ...
    {
        return new QueryMorphToManyRelation($request, $name, $providerClass, ...$args);
    }
    ...
    {
        return function (MorphToMany $relation) use ($data) {
