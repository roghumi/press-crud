...
class QueryMorphToRelation implements IQueryRelation
{
    ...
    {
        return new QueryMorphToRelation($request, $name, $providerClass, ...$args);
    }
    ...
    {
        return function (MorphTo $relation) use ($data) {
